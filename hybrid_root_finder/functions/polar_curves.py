...
from functions.function_meta import ContinuousPolarFunction, ContinuousFunctionMeta
...
ONE_X_THREE = ContinuousPolarFunction(
    ContinuousFunctionMeta(
        ...
        "This is the intersection between the butterfly curve and the third curve of the programming exercise"
    ),
...
ONE_X_FOUR = ContinuousPolarFunction(
    ContinuousFunctionMeta(
        ...
        "This is the intersection between the butterfly curve and the fourth curve of the programming exercise"
    ),
...
TWO_X_THREE = ContinuousPolarFunction(
    ContinuousFunctionMeta(
        ...
        "This is the intersection between the cardioid curve and the third curve of the programming exercise"
    ),
...
TWO_X_FOUR = ContinuousPolarFunction(
    ContinuousFunctionMeta(
        ...
        "This is the intersection between the cardioid curve and the fourth curve of the programming exercise"
    ),
...
THREE_X_FOUR = ContinuousPolarFunction(
    ContinuousFunctionMeta(
        ...
        "This is the intersection between the third and fourth curves of the programming exercise"
    ),
